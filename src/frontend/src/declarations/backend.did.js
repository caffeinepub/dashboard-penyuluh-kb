...
export const idlService = IDL.Service({
  ...
  'getAllReports' : IDL.Func([], [IDL.Vec(LaporanRencanaKerja)], ['query']),
  'getCallerUserProfile' : IDL.Func([], [IDL.Opt(UserProfile)], ['query']),
  'getCallerUserRole' : IDL.Func([], [UserRole__1], ['query']),
  'getMyReports' : IDL.Func([], [IDL.Vec(LaporanRencanaKerja)], ['query']),
  ...
  'updateReport' : IDL.Func([IDL.Text, LaporanUpdate], [], []),
});
